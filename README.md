...
Completing this project ensures an opportunity to understand relational algebra and its applications to large data models. Creating ERDs provides clear visuals for the connections among different table to understand the use of primary keys and foreign key to create accurate tables that represent the data stored. Proper use of relational algebra makes sure the design data structure relates to one another in the proper cardinality. Understanding the design for tables in how attributes and tuples are used determines how well the data is stored.
